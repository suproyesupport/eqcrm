        ...
        var columnas = [
            {
                ...
                cellTemplate: function (container, options) {
                    ...
                    container.append($("<button value=\"" + options.key + "\" onclick=\"BuscarOrden(this.value, '" + options.values[2] + "');\" class=\"btn btn-xs btn-dark waves-effect waves-themed\">Mod.</button><button value=\"" + options.key + "\" onclick=\"PDFOrdenServicio(this.value, '" + options.values[2] + "');\" class=\"btn btn-xs btn-danger waves-effect waves-themed\">PDF</button><button onclick=\"ModalFotos();\" class=\"btn btn-xs btn-secondary waves-effect waves-themed\">📷</button>")).appendTo(container);
...
//FUNCION PARA CARGAR EL DETALLE DE LA ORDEN
