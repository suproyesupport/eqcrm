...
function GuardarOrdenServicio() {
    ...
    let arr = { id_orden, serie, fechaingreso, fechaentrega, asesores, idcliente, cliente, direccion, nit, tipoVenta, diascredito, obs, contacto, telefono, correo, aseguradoras, poliza, asesoremergencia, reclamo, corredora, deducible, ajustador, opciones, tiposvehiculos, marca, lineavehiculo, modelo, tipoplaca, placa, color, chassis, kilometraje, medida, total };
    ...
    $.ajax({
        ...
        url: "/IngresoOrdenServicio/GuardarOrdenServicio",
