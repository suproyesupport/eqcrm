...
function ModalAgregar() {
    ...
    //document.getElementById("btn-generico").hidden = true;
...
function ConfirmarIngresoKardex() {

    $("#modal-generico").modal('show');

    //document.getElementById("MyElement").className = "MyClass";

    //document.getElementById("mensaje").innerHTML = "¿Desea ingresar la entrada?";
    //document.getElementById("btn-generico").hidden = false;

    //$("#modal-generico").modal('show');

    //document.getElementById("btn-generico").onclick = function () { recorrerIngresoKardex() };
