...
function BuscarID() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            document.getElementById("lineaeq").value="";wh
...
function GuardarProducto() {
    ...
    let idcodigoeq = document.getElementById("idcodigoeq").value;
    let codigoeq = document.getElementById("codigoeq").value;
    let alias = document.getElementById("alias").value;
    let producto = document.getElementById("productoeq").value;
    ...
    let costoeq1 = document.getElementById("costoeq1").value;
    let costoeq2 = document.getElementById("costoeq2").value;
    let costoeq3 = document.getElementById("costoeq3").value;
    let costoeq4 = document.getElementById("costoeq4").value;

    let precioeq1 = document.getElementById("precioeq1").value;
    let precioeq2 = document.getElementById("precioeq2").value;
    let precioeq3 = document.getElementById("precioeq3").value;
    let precioeq4 = document.getElementById("precioeq4").value;

    let stockmin = document.getElementById("stockmin").value;
    let stockmax = document.getElementById("stockmax").value;
    //var chkservicio = document.getElementById("defaultUnchecked").value;
    let chkservicio = $('#defaultUnchecked').prop('checked');
...
function limpiarCampos() {
    ...
    document.getElementById("costoeq3").value = "";
    document.getElementById("costoeq4").value = "";

    document.getElementById("precioeq1").value = "";
    document.getElementById("precioeq2").value = "";
    document.getElementById("precioeq3").value = "";
    document.getElementById("precioeq4").value = "";
