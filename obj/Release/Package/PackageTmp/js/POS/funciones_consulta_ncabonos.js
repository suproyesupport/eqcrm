...
function BuscarVentas() {
    ...
    function ResultadoConsulta(data) {
        ...
        //            container.append($("<table class=\"table table-bordered m-0\"><tr><td><a data-toggle='modal'  style='color:#651FFF;cursor:pointer;' data-target='.VER_FACTURAS' class='UUID' id='" + options.data.UUID + "'><img src='/images/folder.png' width='35' height='35'></a></td>" + "<td></tr></table >")).appendTo(container);
