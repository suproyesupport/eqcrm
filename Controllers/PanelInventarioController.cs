...
{
    public class PanelInventarioController : Controller
    {
        // GET: PanelInventario
        public ActionResult PanelInventario()
        {
        ...
        public object GetInventario()
        {
            ...
            else
            {
                ...
                //cInst = "SELECT  CONCAT(a.id_codigo,' ','') AS DATOS,a.id_codigo as CODIGO, a.producto AS PRODUCTO,a.umedida AS UMEDIDA,ifnull(sum(b.entrada-b.salida),0) AS EXISTENCIA,a.precio1 AS PRECIO1,a.costo2 AS COSTO ";
                //cInst += " FROM inventario a ";
                //cInst += " RIGHT JOIN  kardexinven b ON (a.id_codigo= b.id_codigo) ";
