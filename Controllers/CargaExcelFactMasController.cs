...
{
    public class CargaExcelFactMasController : Controller
    {
        // GET: CargaExcelFactMas
        public ActionResult CargaExcelFactMas()
        {
            return View();
        }

        [HttpPost]
        public string CargarFactMasiva(string informacion)
        {
